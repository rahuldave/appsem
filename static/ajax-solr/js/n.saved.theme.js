  ...
  AjaxSolr.theme.prototype.saved_formactions = function(saveingrouphandler, savetotagshandler, throwhandler, bibtexHandler, myADSHandler) {
    ...
    if (!(bibtexHandler === null && myADSHandler === null)) {
      return $('<div class="formactions"/>').append($('<input class="btn small" type="button" value="Mark all"/>').click(changeAllButtons(true))).append($('<input class="btn small" type="button" value="Clear all"/>').click(changeAllButtons(false))).append($('<span>&nbsp;<span class="label"/>&nbsp;</span>')).append($('<input class="btn btn-danger small" type="submit" value="Delete" name="action"/>')).append($('<span>&nbsp;<span class="label"/>&nbsp;</span>')).append($('<select class="groupselect"/>').append(((function() {
        ...
        return _results;
      })()).join(''))).append($('<input class="btn btn-primary small" type="button" value="Save to Collabs" name="action"/>').click(saveingrouphandler)).append($('<span>&nbsp;<span class="label"/>&nbsp;</span>')).append($('<input class="medium tagstext" type="text"/>')).append($('<input type="button" class="btn small btn-info" value="Add Tags" name="Tag"/>').click(savetotagshandler)).append($('<span>&nbsp;<span class="label"/>&nbsp;</span>')).append($('<input class="btn btn-info small" type="button" value="View"/>').click(throwhandler)).append($('<span>&nbsp;<span class="label"/>&nbsp;</span>')).append($('<input class="btn btn-info small" type="button" value="Get as BibTex"/>').click(bibtexHandler)).append($('<button type="button" name="myads" value="Send to myADS"/>').click(myADSHandler).append($('<img alt="[myADS logo]"/>').attr('src', "" + SITEPREFIX + "/static/images/ADSlabs-button.png")));
    }
    $thediv = $('<div class="formactions"/>').append($('<input class="btn small" type="button" value="Mark all"/>').click(changeAllButtons(true))).append($('<input class="btn small" type="button" value="Clear all"/>').click(changeAllButtons(false))).append($('<span>&nbsp;<span class="label"/>&nbsp;</span>')).append($('<input class="btn btn-danger small" type="submit" value="Delete" name="action"/>')).append($('<span>&nbsp;<span class="label"/>&nbsp;</span>')).append($('<select class="groupselect"/>').append(((function() {
      ...
      return _results;
    })()).join(''))).append($('<input class="btn btn-primary small" type="button" value="Save to Collabs" name="action"/>').click(saveingrouphandler)).append($('<span>&nbsp;<span class="label"/>&nbsp;</span>')).append($('<input class="medium tagstext" type="text"/>')).append($('<input type="button" class="btn small btn-info" value="Add Tags" name="Tag"/>').click(savetotagshandler));
