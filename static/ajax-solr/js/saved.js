(function() {
  ...
  handleItemsWithPK = function(widgetname, handler, itemstype, recreate) {
    return function() {
      var data, ele, fqGroupName, ihash, item, items, objectsToSave, tagName, thetype, _i, _len;
